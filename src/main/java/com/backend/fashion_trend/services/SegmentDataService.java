    ...
    public class SegmentDataService {
        ...
        public List<SegmentData> getAllSegments() {
            return segmentDataRepository.findAll();
        }

        public List<SegmentData> getRecentActivity() {
            return segmentDataRepository.findAllByOrderByTimestampDesc(PageRequest.of(0, 10));
        }
    }
