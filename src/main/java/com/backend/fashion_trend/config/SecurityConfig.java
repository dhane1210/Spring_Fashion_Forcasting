...
import com.backend.fashion_trend.filters.JwtAuthenticationFilter;
import com.backend.fashion_trend.user.UserDetailsServiceImpl;
        ...
        return http
                ...
                .authorizeHttpRequests((requests) ->
                        requests
                                ...
                                .requestMatchers("/api/**").permitAll() // Allow Frontend Access
